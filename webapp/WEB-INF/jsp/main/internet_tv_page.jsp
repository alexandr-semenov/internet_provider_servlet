...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm">
                <div class="col-sm">
                    <div class="card bg-primary text-white banner-height">
                        <div class="card-img-overlay">
                            <div class="align-self-center banner-parent">
                                <h3 class="card-text text-center banner-child"><fmt:message key="internet_tv_page_title"/></h3>
                            </div>
                        </div>
                    </div>
                    <div class="slider">
                            ...
                            <div class="col-sm-4">
                                <div class="card border-primary" style="width: 20rem;">
                                    <div class="card-body text-center text-primary">
                                        ...
                                        <a href="/subscription/?tariff_id=${tariff.id}" class="btn btn-primary text-white"><fmt:message key="order_button"/></a>
                                    </div>
                                </div>
                            </div>
                        </c:forEach>
